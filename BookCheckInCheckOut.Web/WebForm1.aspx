<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm1.aspx.cs" Inherits="BookCheckInCheckOut.Web.WebForm1" %>

<!DOCTYPE html>
<html lang="en">

<head runat="server">
    <title>Book Check In/Out</title>
    <meta charset="utf-8">
    ...
    <!-- chartist CSS -->
    <link href="<%=ResolveClientUrl("~/Contents/material-lite/assets/plugins/chartist-js/dist/chartist.min.css") %>" rel="stylesheet">
    <link href="<%=ResolveClientUrl("~/Contents/material-lite/assets/plugins/chartist-js/dist/chartist-init.css") %>" rel="stylesheet">
    <link href="<%=ResolveClientUrl("~/Contents/material-lite/assets/plugins/chartist-plugin-tooltip-master/dist/chartist-plugin-tooltip.css") %>" rel="stylesheet">
    <!--This page css - Morris CSS -->
    <link href="<%=ResolveClientUrl("~/Contents/material-lite/assets/plugins/c3-master/c3.min.css") %>" rel="stylesheet">
    <!-- Custom CSS -->
